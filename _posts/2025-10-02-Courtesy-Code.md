...
![The Courtesy Code](/assets/images/courtesy-1.png)

> If a machine responds better to courtesy, maybe it's just proving that good manners are finally contagious â€” even to our own inventions.

In the early days, when models were still clunky but my expectations were sky-high, I would get frustrated:

>"But I just said this â€” why aren't you remembering it?"
...
Her reminder stopped me. It felt absurd â€” but also familiar.
...
![Rude prompt example](/assets/images/courtesy-2.png)

 rude prompt

![Courteous prompt example](/assets/images/courtesy-3.png)
courteous prompt
...
If a machine, without ego, performs better when treated courteously, what does that say about us â€” the creatures who wrote the data it trained on? We like to think we're rational. But like the model, we're swayed by signals we barely notice.

>Politeness is a social shorthand â€” a small phrase that carries a big meaning: "I respect you. I see you. I value your answer."
...
![Courtesy comparison](/assets/images/courtesy-4.png)
---
...
The next reflection is about [context](/2025/10/07/context/) — the frame that makes meaning possible.
---
